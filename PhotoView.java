...
import frame.libsource.R;

/**
 * Layout for the photo list view header.
 * copy from com.android.ex.photo.views.PhotoView by 2021.02.07
 */
public class PhotoView extends View implements OnGestureListener,
    ...
    private void initialize(Context context, AttributeSet attrs, int defStyle) {
        if (!sInitialized) {
            ...
            TypedArray a = context.getTheme().obtainStyledAttributes(attrs, R.styleable.PhotoView, defStyle, 0);
            int cropWidth = a.getDimensionPixelSize(R.styleable.PhotoView_photo_crop_width, 0);
            int dimColor = a.getColor(R.styleable.PhotoView_photo_crop_dim_color, Color.BLACK);
            int highlightColor = a.getColor(R.styleable.PhotoView_photo_crop_highlight_color, Color.WHITE);
            int strokeWidth = a.getColor(R.styleable.PhotoView_photo_crop_stroke_width, 0);
            a.recycle();
